            ...
            try
            {
                ...
                vehiculos.Add(new Vehiculo()
                {
                    ...
                    cliente = new Cliente()
                    {
                        ...
                        apellidocliente = collection["Cliente.apellidocliente"],
                        correocliente = collection["Cliente.correocliente"],
                        sexocliente = collection["Cliente.sexocliente"],
                        fecnacliente = collection["Cliente.fecnacliente"],
                        departamentocliente = new Departamento()
                        {
                            codigodepartamento = int.Parse(collection["Departamento.codigodepartamento"]),
                            nombredepartamento = collection["Departamento.nombredepartamento"]
                        },
                        provinciacliente = new Provincia()
                        {
                            codigoprovincia = int.Parse(collection["Provincia.codigoprovincia"]),
                            nombreprovincia = collection["Provincia.nombreprovincia"]
                        },
                        distritocliente = new Distrito()
                        {
                            codigodistrito = int.Parse(collection["Distrito.codigodistrito"]),
                            nombredistrito = collection["Distrito.nombredistrito"]
                        }
                    }
                });
